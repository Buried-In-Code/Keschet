...
import github.buriedincode.pieces.*;
import github.buriedincode.players.AutoStartConsolePlayer;
...
public class Keschet {
  ...
  private void placePiece(@NotNull Player player, @NotNull Piece piece) {
    ...
    do {
      ...
      } else if ((player.getColour() != Colour.YELLOW || location.getRow() >= 3)
          && (player.getColour() != Colour.RED || location.getRow() <= 6)) {
